...
const BannerSection = () => {
  return (
    ...
    >
      <section
        className={`
          section-banner section-id-template--26430796759383__f1214721-46d5-4d18-93ff-183e7995facb relative-sec
          pt-0 pb-0
          lg:pt-0 lg:pb-0
          rounded-none bg-[#262424]
        `}
      >
        <div className="banner-wrap">
          <div className="snippet-banner block-id-e2167cfe-0cac-4332-a4c6-2bae7bb09dec full-width">
            <div className="mainbnr_wrap banner img_banner">
              {/* Desktop Image - Large screens (1024px+) */}
              <Image 
              ...
              {/* Mobile Image - Small to Medium screens (below 1024px) */}
              <Image
              ...
              <div className={`
                banner-con desk_right mob_right deskver_bottom mobver_bottom
              `}>
                <div className={`
                  banner-coninr deskhor_right mobhor_right
                `}></div>
              </div>
            </div>
          </div>
