  ...
  return (
    <>
      <div id="shopify-section-template--26430797775191__f32a1c2e-c486-4763-9d59-ecf248ea3345"
        ...
        <link
          href="//www.notsellingliquid.com/cdn/shop/t/39/assets/case-studies.css?v=106501624443217175951758090047"
          rel="stylesheet" type="text/css" media="all" />
        <section
          className="section-case-studies section-id-template--26430797775191__f32a1c2e-c486-4763-9d59-ecf248ea3345 relative-sec">
          <style>
            {`
              ...
              #shopify-section-template--26430797775191__f32a1c2e-c486-4763-9d59-ecf248ea3345 .cs-header {
