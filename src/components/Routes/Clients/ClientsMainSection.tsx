                ...
                <div className="relative">
                    <div className="relative">
                        ...
                        <video 
                            ...
                            loop={true} 
                            preload="metadata"
                            className="w-full h-auto hidden lg:block rounded-b-[15px]" 
                            ...
                            <source
                                src="https://www.notsellingliquid.com/cdn/shop/videos/c/vp/d5f3186a25b34e6aabe7cc582edd3c17/d5f3186a25b34e6aabe7cc582edd3c17.HD-1080p-2.5Mbps-17527902.mp4?v=0"
                                type="video/mp4" />
                            <Image 
                                alt="Shopify Plus Agency Case - Arte Antwerp"
                                src="https://www.notsellingliquid.com/cdn/shop/files/preview_images/d5f3186a25b34e6aabe7cc582edd3c17.thumbnail.0000000000_small.jpg?v=1692610307" 
                                width={1689}
                                height={2111}
                        ...
                        <Image 
                            src="https://www.notsellingliquid.com/cdn/shop/files/9-arte.jpg?v=1692609357"
                            alt="Shopify Plus Agency Case - Arte Antwerp" 
                            width={1689}
                            height={2111}
                            className="w-full h-auto block lg:hidden rounded-b-[15px]"
                            priority
                        />
                                ...
                                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end">
                                    <div className="mb-6 lg:mb-0">
                                        ...
                                        <div className="flex gap-2">
                                            <span className="text-xs px-2 py-1 bg-white/10 rounded">build</span>
                                            <span className="text-xs px-2 py-1 bg-white/10 rounded">manage</span>
                                            <span className="text-xs px-2 py-1 bg-white/10 rounded">grow</span>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <a href="/pages/case-study-arte-antwerp-360-approach" className="inline-flex items-center gap-2 text-sm lg:text-base hover:opacity-80 transition-opacity">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="w-4 h-4">
                                                <path fillRule="evenodd" clipRule="evenodd"
                                                    d="M8.375 2.79297L13.5821 8.00008L8.375 13.2072L7.66789 12.5001L11.6679 8.50008H2.625V7.50008H11.6679L7.66789 3.50008L8.375 2.79297Z"
                                                    fill="currentColor"></path>
