...
const AboutIntroSection = () => {
  return (
    <div id="shopify-section-template--26430796890455__e888cf0f-1c90-47ca-a12b-c0a1b957457e"
                ...
                <section
                    className="section-about-intro section-id-template--26430796890455__e888cf0f-1c90-47ca-a12b-c0a1b957457e relative-sec">
                    <style>
                    ...
                    <div className="container">
                        <div className="about-intro grid">
                            ...
                            <div className="ai-right grid-4-lcol">
                                <div className="ai-rightinr">
                                    <div className="s-body d-none d-lg-block">We&apos;ve taken things we&apos;re passionate about -
                                        fashion, sneakers and all things digital - and made it our craft.</div>
                                    <div className="s-caption">
                                        <p>We&apos;re creating a space where e-commerce expertise is combined with an
                                            intrinsic fashion mindset to grow next generation brands in the digital
                                            landscape.</p>
                                    </div><a href="/pages/manifesto" className="link-arrow">
                                        <span className="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <div className="intro_overly">&nbsp;</div>
                    </div>
                </section>
            </div>
  )
