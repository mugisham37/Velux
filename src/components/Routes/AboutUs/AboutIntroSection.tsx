...
const AboutIntroSection = () => {
  return (
    <div className="block">
      <section className="relative bg-[#262424] py-16 lg:py-20">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-8">
            ...
            <div className="w-full lg:w-5/12 lg:ml-auto">
              <div className="lg:pl-4">
                <div 
                  className="hidden lg:block text-white text-sm lg:text-base mb-6 leading-relaxed"
                  style={{ fontFamily: 'Aeonik, sans-serif' }}
                >
                ...
                <div className="mb-8">
                  <p 
                    className="text-white text-xs lg:text-sm leading-relaxed"
                    style={{ fontFamily: 'Aeonik, sans-serif' }}
                  >
