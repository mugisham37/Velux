          ...
          <div className="about-steps grid">
            ...
            <div className="as-right gridr-6-lcol">
              ...
              <div className="as-rightinr mbscroll-hide">
                ...
                <div className="as-text block-id-cdb193de-b8e7-4bfa-9c65-caaf4daa85dd">
                  <span className="xl-body">02</span>
                  <p className="m-body">Collaboration as the norm</p>
                  <div className="s-caption">
                ...
                <div className="as-text block-id-4f4d9a73-bcd5-4f89-8e21-f368a5f397c7">
                  <span className="xl-body">03</span>
                  <p className="m-body">authentic stories</p>
                  <div className="s-caption">
                ...
                <div className="as-text as-only-text block-id-9598ab58-6fb3-4513-bf56-9d5c7ac7e310">
                  <h5>A mindset and culture in which we live, collaborate and share the same stories.</h5>
                </div>
              </div>
            </div>
          </div>
